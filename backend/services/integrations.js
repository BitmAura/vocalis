function configured() {
  ...
  return {
    ...
    googleCalendar: googleCal.isConfigured(),
    ...
    mediaStream: !!(process.env.USE_MEDIA_STREAM === 'true' || process.env.USE_MEDIA_STREAM === '1' || process.env.VOICE_WS_URL),
    voiceWsUrl: process.env.VOICE_WS_URL || null
  };
}
